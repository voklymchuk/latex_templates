...
%adjust size of code listings automatically in beamer
...
%use \Verbatim command instead of \verbatim
%\usepackage{fancyvrb}
...
\begin{table}
\tablefirsthead{\toprule  & \bf document class  &\bf bibliography style &   \\ \midrule}
\tablehead{\midrule &\bf document class &\bf bibliography style &  \\ \midrule}
\tablecaption{Sample multipage table with repeating header}
...
\begin{xtabular}{
		...
		\hline 
		Text 1 & Text 2 & Text 3 & Text 4   \\ \hline
		1      &      2 & 3      & 4 \\	\hline		
		\bottomrule
\end{xtabular}
...
\tablecaption{Document and bibliograpghy styles with repeating header}
\begin{xtabular}{
		p{0.27\linewidth}
		p{0.27\linewidth}
		p{0.23\linewidth}
	...
	\midrule
	Lecture Notes in Computer Science& \Verb|llncs|& \Verb|splncs|& \raisebox{-0.5\totalheight}{\includegraphics[width=1\linewidth]{llncs.png}} \\ 
	\midrule
